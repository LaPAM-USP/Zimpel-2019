...
#PCA Analysis using SNPs information 

#input: multifasta output from the build_snp_alignment_positions.py   
#input: tabular txt file containing all the genomes names, tab separated by the number of each group, herein named as "group_pca.txt"
  # example: genomeA  1
  #          genomeB  2
  #          ...
  #          genomeF  7
  
#colors and lineage: 1 to 7, in case of using 7 different groups
...
# Load data
# alignment
AlnFile <- "SNPinput.fa" #"the input will be your snp.fasta"
